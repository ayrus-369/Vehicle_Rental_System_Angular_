...
@Component({
  selector: 'app-deactivated-cars',
  standalone: true,
  imports: [CommonModule,FormsModule,SearchCarPipe],
  templateUrl: './deactivated-cars.component.html',
  styleUrl: './deactivated-cars.component.css'
})
export class DeactivatedCarsComponent {
  searchTerm:string="";
  message:string="";
  errorMessage:string="";
  cars:Car[]=[]
        ...
        this.vehicleService.getAllVehicles.subscribe(
          {
            next:(data: any)=>{
              ...
              this.cars = data.filter((car: any) => !car.active);
